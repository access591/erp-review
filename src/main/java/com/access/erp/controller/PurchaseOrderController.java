...
public class PurchaseOrderController {
	...
	public QuotationPartyState getQuotationInfo(@PathVariable(value = "id") String quotId, Model model) {
		...
		// null check
		if (quotationDetail.getParty() != null) {

			party = partyMasterService.editPartyMaster(quotationDetail.getParty().getPartyCode()).get();
	...
	public ItemOpenIndentDetail ItemInfoByItemCode(@PathVariable(value = "itemCode") String itemCode,
		...
		// OpenIndentDetail findByIndItemCodeAndOpenIndent(StriindentItemCode,OpenIndent
		// openIndent);
