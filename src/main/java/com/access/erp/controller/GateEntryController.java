...
public class GateEntryController {
	...
	public String deleteGateEntry(@PathVariable("id") String gateEntryCode, Model model,
			RedirectAttributes redirectAttributes) {
	...
	public List<PurchaseOrderItem> itemDetailInPoDetail(@PathVariable(value = "poNumber") String poNumber,
			Model model) {
	...
	public PurchaseOrderItem_Item itemInfo(@PathVariable(value = "itemNumber") String itemNumber,
			@PathVariable(value = "poNumber") String poNumber, Model model) {
